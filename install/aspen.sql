...
DROP TABLE IF EXISTS borrowbox_settings;
CREATE TABLE `borrowbox_settings` (
...
DROP TABLE IF EXISTS borrowbox_scopes;
CREATE TABLE `borrowbox_scopes` (
  id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
DROP TABLE IF EXISTS borrowbox_api_product_metadata;
CREATE TABLE `borrowbox_api_product_metadata` (
  id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
DROP TABLE IF EXISTS user_borrowbox_usage;
CREATE TABLE `user_borrowbox_usage` (
  id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  instance VARCHAR(100),
...
DROP TABLE IF EXISTS borrowbox_extract_log;
CREATE TABLE `borrowbox_extract_log` (
  id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  settingId INT(11) NOT NULL,
