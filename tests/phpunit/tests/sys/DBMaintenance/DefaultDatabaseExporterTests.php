 ...
 *
 * The generated file bootstraps every new installation and failures are silent
 * (the export succeeds; a fresh install later breaks), so these tests pin the
 * structural guarantees: full schema coverage, importable statements, and
 * insert column lists that always match the schema they were generated from.
 */
