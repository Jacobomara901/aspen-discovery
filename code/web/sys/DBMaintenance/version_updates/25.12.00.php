...
function getUpdates25_12_00(): array {
	return [
		...
		'library_events_default_calendar_view' => [
			...
			'continueOnError' => false,
			'sql' => [
				"ALTER TABLE library ADD COLUMN eventsDefaultCalendarView TINYINT(1) DEFAULT 0 COMMENT '0 = All Locations, 1 = Use library's main branch location, 2 = Use first library location (alphabetically)'"
			]
		],
