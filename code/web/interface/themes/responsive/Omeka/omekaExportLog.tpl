{strip}
	<div id="main-content" class="col-md-12">
		<h1>{translate text="Omeka Export Log" isAdminFacing=true}</h1>

		{include file='Omeka/omekaExportLogFilters.tpl'}
				...
				<tbody>
					{foreach from=$logEntries item=logEntry}
						<tr>
							...
							<td><a href="#" onclick="return AspenDiscovery.Admin.showExtractNotes('{$logEntry->id}', 'omeka');">{translate text="Show Notes" isAdminFacing=true}</a></td>
						</tr>
					{/foreach}
				</tbody>
			</table>
