...
// jacob
- Fix an error when loading two-factor authentication method status with no logged-in user. ([DIS-2454](https://aspen-discovery.atlassian.net/browse/DIS-2454)) (*JOM*)
