...
// jacob
- Add reusable pagination helpers to the API framework, standardising page and pageSize handling for new endpoints. ([DIS-2674](https://aspen-discovery.atlassian.net/browse/DIS-2674)) (*JOM*)
- Add an events harvest API for the LibraryOn integration, returning paginated public or permission-scoped events with nested instances. ([DIS-2676](https://aspen-discovery.atlassian.net/browse/DIS-2676)) (*JOM*)
