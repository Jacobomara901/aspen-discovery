...
class SystemAPI extends AbstractAPI {
	...
	public function getDatabaseUpdates(): array {
		...
		$baseUpdates = array_merge($library_location_updates, $summonUpdates, $cloudLibraryUpdates, $grapesWebBuilderUpdates, $communityEngagementUpdates, $talpaUpdates, $heycentricUpdates, $hooplaVersion2Updates, $pay360Updates, $apiOAuthUpdates);
